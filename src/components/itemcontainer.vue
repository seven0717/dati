<template>
  <div style="color: #fff" class="aaa">
    <!--头部-->
    <header class="top_tips">
      <span class="num_tip" v-if="father === 'home'">{{ level }}</span>
      <span class="num_tip" v-if="father === 'item'">题目{{ itemNum }}</span>
    </header>

    <!--home-->
    <div v-if="father === 'home'">
      <div class="home_logo item_container_style"></div>
      <router-link to="items" class="start button_style"></router-link>
    </div>
    <!--items-->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState(['level', 'itemNum', 'itemDetail', 'timer','allTime'])
    },
    methods: {
